                ...
                <div class="lg:col-span-3 bg-white text-gray-800 rounded-2xl p-6 md:p-8 shadow-2xl relative">
                    ...
                    <div class="flex flex-wrap items-center gap-6 mb-6 text-sm">
                        <div class="flex items-center gap-2">
                            <span class="bg-gray-100 text-gray-500 text-xs px-2.5 py-1 rounded-md font-medium">Status</span>
                            <span class="text-gray-600 font-medium">{{ task.status_label }}</span>
                        </div>
                        <div class="flex items-center gap-2">
                            <span class="bg-gray-100 text-gray-500 text-xs px-2.5 py-1 rounded-md font-medium">Priority</span>
                    ...
                    <div class="bg-[#f7fafc] rounded-xl p-5 md:p-6 border border-gray-100 space-y-5 mb-6">
                        ...
                        <p v-if="task.body" class="text-sm text-gray-500 leading-relaxed pt-2">
                            {{ task.body }}
                        </p>
                        ...
                        <div class="bg-white border border-gray-100 rounded-xl p-4 shadow-sm text-xs text-gray-500 space-y-1">
                            <p>
                                <span class="font-bold text-gray-800">AI Summary:</span>
                                {{ task.ai_summary_short }}
                            </p>
                            <p>
